...
public class ValidRegistration {
	String driverPath="F:\\phase 5\\chromedriver_win32\\chromedriver.exe";
...
{
	System.setProperty("webdriver.chrome.driver","F:\\phase 5\\chromedriver_win32\\chromedriver.exe");
