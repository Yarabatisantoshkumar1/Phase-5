...
public class LoginTestScript {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		addDetailsToLoginForm(driver, "Santosh", "Santosh1@gmail.com", "Santosh@123");// get login data
		addDetailToRegisterForm(driver, "santosh1@gmail.com", "Santosh", "Santosh@123");// get register data
